...
void kmeans(centroid* ,point* , int , int ,int , int, int, int, int, int , FILE* );
...
int cosine_hash_centroid(centroid , int , int , int , double** );
...
void shilouette_evaluation(FILE*, centroid* ,point* ,int, int ,int );
void *change_mem(void *, size_t , size_t );
int check_lsh_convergence(int *,int *, int);
void print_stuff1(FILE* , int , int , int , int );
void fprint_coordinates_cent(FILE* , centroid , int );
void cosine_lsh_query(point* , centroid* , hashtable* , int , int , int , int , double , int , int , int , double** , int** , double*** );
void hypercube_assignment(centroid* , point* , int , int , int , int , int , int *);
void hypercube_query(point* , centroid* , hashtable  , int , int , int , double , int , int , int , int , double** );
