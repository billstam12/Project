...
int** cosine_lsh_implementation(user* , int , int , int, char**, char*);
double** init(hashtable* , user * , int , int , int, int , int , int , int , double ** ,  int ** );
int cosine_hash(user , int , int , int , double** );
int** cosine_lsh_query(user* , hashtable , int ,  int , int , int , int , int , int , double** , int** , double** , int, char**, char*);
int cmp(const void *, const void *);
void cosine_cluster_implementation(user *, int , int , int , int , int , char** , char* );
...
int** k_means_recommend(centroid* , user* , int , int , int , int , int , char**, char* );

void clustering_lsh_implementation(user* , cluster* , int , int , int, char**, char* );
void clustering_cluster_implementation(user* , cluster* , int , int , int, char**, char* );
void free_data(tweet * , int , user* , int , cluster* , char ** , int );
