...
void hypercube_query(point* , point* , char*, hashtable , int , int , int , double , int , int , int , int , double** );
...
void euclidean_lsh_query(point* , point* , char*, hashtable* , int, int , int , int , double , int, int, int, double** , int** , double***);
